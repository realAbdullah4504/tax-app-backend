...
const createUserValidator = [
  ...
  body('phoneNumber')
    ...
    .matches(/^(?:\+353|0353|0)?(?:[0-9]{9,10})$/) //for irish phone number
...
const blockUserValidator = [
  ...
  .isIn(['blocked','unBlock']).withMessage('block status must be [block|unBlock]')
];
...
const createMemberValidator = [
  ...
  .isIn(['call_center','staff_member','supervisor','support']).withMessage('role must be [call_center |staff_member|supervisor|support]'),
];
